requirejs(['firebase-config'], function(config){
	...
	var chatComponent = Vue.extend({
					...
					<div class="panel panel-primary">
		                    ...
		                    <div class="panel-body">
		                        <ul class="chat list-unstyled">
									<li class="clearfix" v-bind:class="{left: !isUser(o.email), right: isUser(o.email)}" v-for="o in mensagens">
				...
				created: function() {
					...
					this.$bindAsArray('mensagens', db.ref(roomRef + '/messages'));
				},
				data: function(){
					return {
						user: {
				...
				methods: {
					...
					sendMessage: function(){
						this.$firebaseRefs.mensagens.push({
							name: this.user.name,
							email: this.user.email,
							text: this.message,
							proto: this.user.photo
						});
					}
				}
			});
